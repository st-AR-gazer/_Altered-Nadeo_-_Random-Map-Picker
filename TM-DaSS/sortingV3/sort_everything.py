...
# Pattern2: "Icy Training - <mapnumber>"
...
oneforward_spring2020_pattern_2 = re.compile(
...
oneup_totd_pattern_1 = re.compile(
    rf"^{totd_pattern_group}\s+\((?P<alteration>1-up)\)$",
    re.IGNORECASE
)
...
# Pattern3: "<season> <year> - <mapnumber> - Snowcar"
...
# Pattern4: "<special_map_name> - CarSnow"
#snow_seasonal_pattern_4 = re.compile(
...
straighttothefinish_spring2020_pattern_2 = re.compile(
...
ALL_PATTERNS = [
    ...
    oneback_seasonal_pattern_1, oneback_seasonal_pattern_2, oneback_seasonal_pattern_3, oneforward_training_pattern_1, oneforward_spring2020_pattern_2,
    onedown_seasonal_pattern_1,
    oneleft_seasonal_pattern_1, oneright_seasonal_pattern_1,
    oneup_seasonal_pattern_1,
    ...
    skyfinish_spring2020_pattern_1, skyfinish_seasonal_pattern_2, skyfinish_seasonal_pattern_3, skyfinish_seasonal_pattern_4,
    ...
    snow_seasonal_pattern_1, snow_seasonal_pattern_2, #snow_seasonal_pattern_3,
    ...
    rally_seasonal_pattern_1, rally_seasonal_pattern_2, #rally_seasonal_pattern_3,
    rallycarswitch_seasonal_pattern_1,
    ...
    desert_seasonal_pattern_1, desert_seasonal_pattern_2, #desert_seasonal_pattern_3,
    desertantiboost_seasonal_pattern_1,
    desertcarswitch_seasonal_pattern_1,
    ...
    straighttothefinish_seasonal_pattern_1, straighttothefinish_spring2020_pattern_2,
...
def assign_attributes(item_data: dict) -> dict:
    ...
    if discovery_type:
        ...
        # If no discovery match, check TOTD
        # TOTD is lowest priority, so only assign TOTD if no previous assignment happened
        # i.e., if we don't have a recognized pattern that sets season/year/mapnumber meaningfully
        # In other words, if season and year are None and no discovered type:
        # Actually from your instructions: "if any of the others have a match then totd should not count."
        # This means if we got here, we have done the pattern matching and special UIDs.
        # If no recognized pattern assigned a 'type', we try TOTD.
        if 'type' not in attributes or not attributes['type']:
            if check_totd_map_name(raw_name):
                # If TOTD matches and no previous type, assign TOTD
                attributes['type'] = 'totd'
            else:
                # Otherwise no type at all
                attributes['type'] = None
        else:
            # If we already got a type from discovery (or any other logic), do nothing
            pass
