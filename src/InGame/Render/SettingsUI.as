...
void RenderInterface() {
    ...
    if (UI::Begin(Colorize({"Altered", " ", "Nadeo"}) + "\\$z Random Map Picker", showInterface, UI::WindowFlags::AlwaysAutoResize)) {
...
void RenderEnviroments() { 
    ...
    RenderS_Rally_To_The_Top();

    RenderS_Desert_();
    RenderS_Desert_Carswitch();
    RenderS_Desert_Icy();
    RenderS_Desert_Underwater();
    RenderS_Desert_To_The_Top();
...
void RenderS_Stadium_To_The_Top() {  IsUsing_Stadium_To_The_Top =  UI::Checkbox("[Stadium] To The Top", IsUsing_Stadium_To_The_Top); }
...
void RenderS_Snow_To_The_Top() {     IsUsing_Snow_To_The_Top =     UI::Checkbox("[Snow] To The Top", IsUsing_Snow_To_The_Top); }
...
void RenderS_Rally_To_The_Top() {    IsUsing_Rally_To_The_Top =    UI::Checkbox("[Rally] To The Top", IsUsing_Rally_To_The_Top); }
...
void RenderS_Desert_To_The_Top() {   IsUsing_Desert_To_The_Top =   UI::Checkbox("[Desert] To The Top", IsUsing_Desert_To_The_Top); }
// ############################################################################################################
...
void PopulateAlterationsArrays() {
    ...
    alterationNames.InsertLast("[Stadium] To The Top");
    alterationFuncs.InsertLast(@RenderS_Stadium_To_The_Top);
    ...
    alterationNames.InsertLast("[Snow] To The Top");
    alterationFuncs.InsertLast(@RenderS_Snow_To_The_Top);
    ...
    alterationNames.InsertLast("[Rally] To The Top");
    alterationFuncs.InsertLast(@RenderS_Rally_To_The_Top);
    ...
    alterationNames.InsertLast("[Desert] To The Top");
    alterationFuncs.InsertLast(@RenderS_Desert_To_The_Top);
