...
void Main() {
    ...
    g_lineCount = GetLineCount(IO::FromStorageFolder("New-Sorting-System/ByOther/data.csv")); // Sets the linecount, to be used in rendermenu func // Fix it so that it actually goes to the correct IO::
