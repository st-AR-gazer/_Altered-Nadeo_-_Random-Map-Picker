...
void DeselectAlteredEffects() {
    IsUsing_Cruise = false;
    IsUsing_Fragile = false;
    IsUsing_Full_Fragile = false;
...
void DeselectAlteredFinishLocation() {
    IsUsing_1Down = false;
    IsUsing_1Back = false;
    IsUsing_1Left = false;
...
void DeselectAlteredEnviroments() {
    IsUsing_Stadium_ = false;
    IsUsing_Stadium_Wet_Wood = false;
    IsUsing_Snow_ = false;
    ...
    IsUsing_Rally_CP1_is_End = false;
    IsUsing_Rally_Underwater = false;
...
void DeselectAlteredMulti() {
    ...
    IsUsing_sw2u1l_cpu_f2d1r = false;
    IsUsing_Underwater_Reverse = false;
    IsUsing_Wet_Plastic = false;
